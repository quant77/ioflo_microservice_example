...
@doify('MicroserviceServerOpen', ioinits=odict(valet="",
...
@doify('MicroserviceServerService',ioinits=odict(valet=""))
def microserviceServerService(self, **kwa):
    """
...
@doify('MicroserviceServerClose', ioinits=odict(valet="",))
def microserviceServerClose(self, **kwa):
    """
